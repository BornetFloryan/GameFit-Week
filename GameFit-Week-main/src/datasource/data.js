...
let teams = [
   { name: "Team A", description: "Les Titans sont connus pour leur force brute et leur stratégie implacable." },
   { name: "Team B", description: "Les Phoenixes sont célèbres pour leurs remontées spectaculaires et leur résilience." },
   { name: "Team C", description: "Les Mavericks aiment surprendre leurs adversaires avec un jeu audacieux et des stratégies imprévisibles." },
   { name: "Team D", description: "Les Guardians sont l’équipe la plus méthodique avec une défense presque impénétrable." },
   { name: "Team E", description: "Les Vipers sont rapides et efficaces, excellant dans les contre-attaques rapides." },
   { name: "Team F", description: "Les Berserkers prennent des risques et jouent de manière féroce avec une détermination sans faille." },
   { name: "Team G", description: "Les Shadows opèrent discrètement et manipulent psychologiquement leurs adversaires." },
   { name: "Team H", description: "Les Storm imposent un rythme effréné grâce à leur vitesse et à leur énergie." }
]
